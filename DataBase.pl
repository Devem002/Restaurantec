...
restaurante(['BurguerKing', rapida,['Puntarenas', 'Puntarenas Down Town'],20,'es una cadena de restaurantes de comida rÃ¡pida conocida por sus hamburguesas a la parrilla']).

%Heredia
restaurante(['LungFung',china,['Heredia', 'Mall Paseo de Las Flores'],20,'este restaurante ofrece auténtica comida china, preparada por chefs expertos en la cocina de este país. En su menu encontrarás una amplia variedad de platos tradicionales']).
...
restaurante(['Matsuri', china, ['Alajuela', 'Tropicana, Provincia de Alajuela, Alajuela'],20,'es un local de comida china muy conocido en la zona, no te dejará indiferente']).

%Guanacaste
restaurante(['Yonguang',china,['Guanacaste', 'Provincia de Guanacaste, Liberia'],20,'este restaurante te lleva en un viaje culinario a través de los diferentes sabores de China.']).
...
%Limon
restaurante(['TacoBell', mexicana, ['Limon', 'Sobre carretera Braulio Carrillo, Guapiles, Limon'], 30, 'es una cadena de restaurantes de comida rápida que sirve comida mexicana inspirada en los Estados Unidos']).
